...
";
        ...
        public virtual void HTMLSyntaxHighlight(Range range)
        {
            ...
            range.ClearFoldingMarkers();
            //set folding markers
            range.SetFoldingMarkers("BEGIN", "END", RegexOptions.IgnoreCase);
